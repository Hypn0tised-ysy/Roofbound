...
public class UtilitySlotButton : MonoBehaviour, IPointerClickHandler
{
    [Header("UI")]
    ...
    private void RegisterSkill()
    {
        ...
        SkillSelectionStore.RegisterSkill(skillName, false);
    }
    ...
    {
        UtilitySlotButton[] slots = FindObjectsOfType<UtilitySlotButton>(true);
    ...
    {
        return SkillSelectionStore.TryGetDescription(skillsCatalog, skillName, false, out string description)
            ? description
            : string.Empty;
    }
}
